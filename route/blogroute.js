const { blogController, fashiondata, men, womenData, BeverageCoffee, BeverageTea, sportBags, premium, sportbaby, datadsport, HomeData, PearData, AppleData } = require("../controller/controller");
...
blogRouter.get("/womendress",womenData)
...
blogRouter.get("/apple",AppleData)
